...
# Load Excel file
file_path = 'uploads/TestData.xlsx'  # Replace with your Excel file path
...
output_file_path = 'output_with_sentiment_nigga.xlsx'  # Replace with your desired output file path
